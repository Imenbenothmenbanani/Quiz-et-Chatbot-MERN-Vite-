...
const {
  ...
  getAdminQuizes,
  getQuizAttempts,
  getLeaderboard, // ← doit être exactement comme dans les exports
...
const { chat, reinitializeVectorStore, getStatus } = require("../controllers/aiController");
...
// ← NOUVEAU: Route pour le leaderboard
