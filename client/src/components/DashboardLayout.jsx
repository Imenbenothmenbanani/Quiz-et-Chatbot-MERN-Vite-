                ...
                <span className='space-x-1 md:space-x-3 text-sm md:text-base'>
                    ...
                    </NavLink>
                    {
                        user.role === "admin" ? <>
                            ...
                            <Link to={"/dashboard/leaderboard"} className={`hover:bg-slate-700 transition-all duration-300 px-3 py-1 rounded-full ${location.pathname.includes("leaderboard") && "bg-slate-600"}`}>
                                Leaderboard
                            </Link>
                        </> : <>
