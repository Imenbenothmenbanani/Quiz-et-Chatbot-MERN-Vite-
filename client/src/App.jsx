...
import Leaderboard from "./pages/Leaderboard" // ← NOUVEAU
      ...
      <div className="max-w-[1200px] px-3 mx-auto min-h-screen ">
        <Routes>
          ...
          <Route path="/dashboard">
            ...
            <Route path="leaderboard" element={<LoggedInRoutes><DashboardLayout><Leaderboard /></DashboardLayout></LoggedInRoutes>} /> {/* ← NOUVEAU */}
